...
_LN_SCALE: float = math.log(100.0)   # ≈ 4.605


# ---------------------------------------------------------------------------
# Sharpening S-curve  (unchanged from previous version)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Primitive cost helpers  (return raw, unsharpened values in [0, 1])
# ---------------------------------------------------------------------------
...
class CostFunction:
    ...
    # ------------------------------------------------------------------
    # Insert / Delete  (not sharpened – structural decisions are binary)
    ...
    # ------------------------------------------------------------------
    # Update  (type-aware + S-curve sharpening)
